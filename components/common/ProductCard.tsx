  ...
  return (
    <div className="group">
      ...
      <div className="flex justify-between items-end">
        ...
        className="primary-btn h-14 whitespace-nowrap text-white opacity-0 group-hover:opacity-100 transition ease-in-out duration-200">
          Add to Cart
        </button>
      </div>
    </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    addToCart: (product: ProductData) => dispatch(addToCart(product)),
  };
};
